                                ...
                                <div class="box p-5">
                                    <div class="flex">
                                        <x-base.lucide
                                            ...
                                            icon="Database"
                                        />
                                        <i class="class DatabaseIcon"></i>
                                        <div class="ml-auto">
                                            <x-base.tippy
                                                class="flex cursor-pointer items-center rounded-full bg-success py-[3px] px-2 text-xs font-medium text-white"
                                                as="div"
                                                content="Master Data"
                                            >
                                                Master Data
                                    ...
                                    <div class="mt-1"><a href="{{ route('menu.masterData') }}" data-tw-merge class="mt-5 transition w-full duration-200 border shadow-sm inline-flex items-center justify-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&amp;:hover:not(:disabled)]:bg-opacity-90 [&amp;:hover:not(:disabled)]:border-opacity-90 [&amp;:not(button)]:text-center disabled:opacity-70 disabled:cursor-not-allowed bg-primary border-primary text-white dark:border-primary shadow-md">Pilih Menu</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
